...
public class DBUtil {
    ...
    private static Connection produceConnection() throws Exception {
        ...
        String url = String.format("jdbc:mysql://%s:%s/%s?autoReconnect=true&useUnicode=true&useSSL=false&characterEncoding=utf8&allowMultiQueries=true", config.getIp(), config.getPort(), config.getDataBase());
